...
const HotelCard = ({room,index}) => {
    //  if (!room) return null;
  return (
    <Link to={'/rooms/' + room._id} onClick={() => scrollTo(0, 0)} key={room._id} className='relative max-w-70 bg-white rounded-xl w-full overflow-hidden text-gray-500/90 shadow-[0px_4px_4px_rgba(0,0,0,0.05)]'>
        ...
        <div className='p-4 pt-5'>
            <div className='flex items-center justify-between'>
                ...
                <div className='flex items-center gap-1'>
                    <img src={assets.starIconFilled} alt="star-icoon" />4.5
                </div>
            </div>
