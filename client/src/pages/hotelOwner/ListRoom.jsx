...
const ListRoom = () => {
  ...
  return (
    <div>
      <Title align='left' font='outfit' title='Room Lisitngs' subTitle='View, edit , or manage all lsited rooms. Keep the information up-to-date to privide the best experience for users.' />
          ...
          <tbody className='text-sm'>
{
  rooms.map((item,index) =>(
    <tr key={index}>
      <td className='py-3 px-4 text-gray-700 border-t border0-gray-300'>
        {
          item.roomType
        }
      </td>
