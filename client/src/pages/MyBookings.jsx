...
const MyBookings = () => {
  ...
  return (
    <div className="py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32">
      <Title
        title="My Bookings"
        subTitle="Easily manage your past, current, and upcoming bookings hotel reservation in one place. Plan your trips seamlessly with just a few clicks."
        align="left"
      />
          ...
          >
            <div className="flex flex-col md:flex-row">
              ...
              <div className="flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4">
                <p className="font-palyfair text-2xl">
                  {booking.hotel.name}
